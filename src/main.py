...
results_path = join(dirname(dirname(abspath(__file__))), "new_results")
...
if __name__ == '__main__':
    ...
    map_param = 'env_args.map_name=' + map
    params = ['src/main.py', '--config=qmix', '--env-config=sc2', 'with', 'env_args.map_name=2m_vs_1z']
    ...
    file_obs_path = join(results_path, "log", map_name, algo_name)
